...
kue[6] = new KuePesanan("Putu Ayu", 3000, 600);         kue[7] = new KuePesanan("Bolu Kukus", 3000, 50);         kue[8] = new KuePesanan("Risoles", 4500, 340);         kue[9] = new KuePesanan("Bolu Berry", 5900, 230);         kue[10] = new KueJadi("Melonpan", 7500, 8);         kue[11] = new KueJadi("Cheesecake", 8400, 7);         kue[12] = new KueJadi("Tiramisu", 5000, 7);         kue[13] = new KueJadi("Chococake", 9300, 5);         kue[14] = new KueJadi("Nagasari", 4000, 8);         kue[15] = new KueJadi("Matcha Cake", 8400, 3);         kue[16] = new KueJadi("Vanilla Cake", 5300, 5);         kue[17] = new KueJadi("Cucur Pandan", 4500, 9);         kue[18] = new KueJadi("Klepon", 3000, 7);         kue[19] = new KueJadi("Kue Sus", 5000, 8);         for (Kue i : kue) { 
